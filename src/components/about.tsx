...
const About = () => {
    ...
    return (
        <div ref={ref} className='bg-gray-700 text-white h-screen w-full py-16 overflow-hidden'>
            <motion.div className='flex flex-col items-center justify-center m-auto space-y-10' animate={animation}>
