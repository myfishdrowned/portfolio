    ...
    return(
        <div ref={ref} className='flex flex-col max-w-6xl md:flex-row space-y-8 md:space-y-0 
            ...
            <div className='flex flex-col w-full text-center md:w-3/4 space-y-24'>
                <div className='font-body md:text-lg leading-loose md:leading-loose text-center md:text-left'>
                ...
                <div className='flex flex-col md:flex-row space-y-12 md:space-y-0 md:divide-x divide-opacity-30 divide-graphite text-center justify-between'>
